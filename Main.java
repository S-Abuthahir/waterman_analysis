...
public class Main extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try{
            ...
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/jproject?useSSL=false", "root", "1234");
...
class SignUp extends JFrame implements ActionListener{
    ...
    void storedb(String username,String email, String password , String address, String phone) throws SQLException,ClassNotFoundException{
        Class.forName("com.mysql.cj.jdbc.Driver");
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306?useSSL=false", "root", "1234");
        Statement s = conn.createStatement();
        try{
